...
class Pages:
    ...
    def rerun_process_camera(self,):
        self.process_camera = subprocess.Popen(self.command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
